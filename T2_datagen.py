...
def datagen(camera_files, max_time_len, batch_size):  # I did not use max_time_len
  ...
  Y_batch = np.zeros((batch_size, 886), dtype='float32')
  ...
  while True:
    ...
    #---datagenB3  Y_batch.shape = (25, 886)
