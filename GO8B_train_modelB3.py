...
from O8B_modelB3 import get_model
from O8B_serverB3 import client_generator, BATCH_SIZE
...
if __name__=="__main__":
    ...
    filepath = "./saved_model/O8B_modelB3-BestWeights.hdf5"
    ...
    model.save('./saved_model/O8B_modelB3.h5')
    ...
    np.save('./saved_model/O8B_modelB3_loss', np.array(history.history['loss']))
    lossnpy = np.load('./saved_model/O8B_modelB3_loss.npy')
