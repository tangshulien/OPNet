...
from N10_modelB3 import get_model
from N10_serverB3 import client_generator
...
if __name__=="__main__":
  ...
  filepath = "./saved_model/N10_yuvB3-BestWeights.hdf5"
  ...
  model.save('./saved_model/N10_yuvB3.h5')

  np.save('./saved_model/N10_yuvB3_loss', np.array(history.history['loss']))
  lossnpy = np.load('./saved_model/N10_yuvB3_loss.npy')
  plt.plot(lossnpy)
