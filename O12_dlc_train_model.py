...
from O12_dlc_model import get_model
from O12_dlc_server import client_generator, BATCH_SIZE
...
if __name__=="__main__":
    ...
    filepath = "./saved_model/O12_dlc_model-BestWeights.hdf5"
    ...
    model.save('./saved_model/O12_dlc_model.h5')
    ...
    np.save('./saved_model/O12_dlc_model_loss', np.array(history.history['loss']))
    lossnpy = np.load('./saved_model/O12_dlc_model_loss.npy')
